...
{{- if ( and .Values.persistence.enabled .Values.initChownData.enabled ) }}
  - name: init-chown-data
    {{- $registry := .Values.global.imageRegistry | default (tpl .Values.initChownData.image.registry .) -}}
    ...
    {{- end }}
    imagePullPolicy: {{ tpl .Values.initChownData.image.pullPolicy . }}
...
{{- end}}
  - name: {{ .Chart.Name }}
    {{- $registry := .Values.global.imageRegistry | default (tpl .Values.image.registry .) -}}
    {{- if .Values.image.sha }}
...
{{- end }}
affinity:
{{- include "grafana.nodeaffinity" . }}
{{- include "grafana.podAffinity" . }}
{{- include "grafana.podAntiAffinity" . }}
