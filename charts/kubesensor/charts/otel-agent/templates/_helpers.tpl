...
{{- define "otel-agent.lowercase_chartname" -}}
...
*/}}
{{- define "otel-agent.fullname" -}}
{{- default "kubesense-otel-agent" }}
{{- end }}

{{/*
Create chart name and version as used by the chart label.
*/}}
{{- define "otel-agent.chart" -}}
...
helm.sh/chart: {{ include "otel-agent.chart" . }}
{{ include "otel-agent.selectorLabels" . }}
{{- if .Chart.AppVersion }}
app.kubernetes.io/version: {{ .Chart.AppVersion | quote }}
{{- end }}
app.kubernetes.io/managed-by: {{ .Release.Service }}
{{ include "otel-agent.additionalLabels" . }}
{{- end }}
...
app.kubernetes.io/name: {{ include "otel-agent.name" . }}
...
*/}}
{{- define "otel-agent.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "otel-agent.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "otel-agent.clusterRoleName" -}}
{{- default (include "otel-agent.fullname" .) .Values.clusterRole.name }}
{{- end }}

{{/*
Create the name of the clusterRoleBinding to use
*/}}
{{- define "otel-agent.clusterRoleBindingName" -}}
{{- default (include "otel-agent.fullname" .) .Values.clusterRole.clusterRoleBinding.name }}
{{- end }}

{{- define "otel-agent.podAnnotations" -}}
{{- if .Values.podAnnotations }}
{{- tpl (.Values.podAnnotations | toYaml) . }}
{{- end }}
{{- end }}

{{- define "otel-agent.podLabels" -}}
{{- if .Values.podLabels }}
{{- tpl (.Values.podLabels | toYaml) . }}
{{- end }}
{{- end }}

{{- define "otel-agent.additionalLabels" -}}
...
*/}}
{{- define "otel-agent.serviceEnabled" }}
  {{- $serviceEnabled := true }}
...
*/}}
{{- define "otel-agent.serviceInternalTrafficPolicy" }}
 ...
 */}}
{{- define "otel-agent.convertMemToBytes" }}
  {{- $mem := lower . -}}
  {{- if hasSuffix "e" $mem -}}
...
{{- define "otel-agent.gomemlimit" }}
{{- $memlimitBytes := include "otel-agent.convertMemToBytes" . | mulf 0.8 -}}
