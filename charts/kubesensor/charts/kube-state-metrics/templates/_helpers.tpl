...
{{- default "kubesense-kube-state-metrics" }}
{{- end }}
...
{{- else }}
{{- printf "%s/%s:%s" (tpl .Values.image.registry .) .Values.image.repository (default (printf "v%s" .Chart.AppVersion) .Values.image.tag) }}
{{- end }}
{{- end }}
{{- end }}
